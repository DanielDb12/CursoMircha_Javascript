...
// Ejercicio
 ...
 /* 1) Programa una función que cuente el número de caracteres de una cadena de texto, pe.
  ...
  const contarNumer = (numero = '') =>
  (!numero)

  ? console.log('no has ingresado el valor')
  : console.log(`${numero} tiene un valor de ${numero.length}`) ;

// contarNumer()
// contarNumer('hola perros calientes')
...
const recortarrTexto = (cadena = '', longitud = undefined) => 
(!cadena)
...
recortarrTexto()
recortarrTexto('hola mundo',2)



/* 3) Programa una función que dada una String te devuelva un Array de 
textos separados por cierto caracter, pe.
...
? console.warn('no has ingresado el caracter')
: (separador === undefined)
	?console.error('no has ingresado la separacion')
	:console.info(cadena.split(separador))

// separarTexto()
// separarTexto('hola mundo perro',',')
